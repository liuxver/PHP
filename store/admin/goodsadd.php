	...
	<body>
		<form action="goodssave.php?flag=1" method="post" name="form1" onsubmit="return checkflds()">
			<table align="center"cellpadding="0" cellspacing="0" width="90%" border="2" bordercolorlight="red" bordercolordark="blue">
				<tr>
					<td align="center" width="100%" colspan="3" bgcolor="antiquewhite" height="28" ><font color="black"><b>添加图书信息</b></font></td>
				</tr>
				<tr>
					<td align="right" width="25%" bgcolor="antiquewhite">图书名称:</td>
				...
				<tr>
					<td align="right" bgcolor="antiquewhite" width="25%">商品数量:</td>
