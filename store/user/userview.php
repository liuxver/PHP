								...
								<td valign="top" colspan="2" align="center">
									<table border="2" width="100%" cellspacing="0" bordercolorlight="red" bordercolordark="blue">
										...
										<tr>
											...
											<td align="center" width="20%" bgcolor="antiquewhite">操作</td>
										</tr>
									<?php
										session_start();
										$uid=$_GET["uid"];
										...
										$objsell=new sell();
										$result=$objsell->getselllist($uid);
										...
										//	echo($row1[2]);
											$id=$row1[2];
											$resultgoods=$obj->getgoodsinfo1($id);
											if($row=$resultgoods->fetch_row()){
									?>
										<tr>
											...
											<td align="center" bgcolor="antiquewhite">
												...
												<a href="selldelete.php?gid=<?php echo($row1[2]); ?>&uid=<?php echo($row1[1]); ?>" target=_blank>删除</a>&nbsp;&nbsp;
											</td>
										</tr>
										<?php
											$m=$m+1;
